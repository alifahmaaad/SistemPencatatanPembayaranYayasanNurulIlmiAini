...
import {
  ...
  getpakaianbyidkelas,
  setpakaianBayar,
} from "../../../Database/pakaian/dbpakaian";
...
const Datapakaian = () => {
  ...
  const handleEdit = async () => {
    ...
    await editpakaian(idedit, jumlahTerhutang);
    setReseter(reseter + 1);
    handleCloseEdit();
  };
  useEffect(() => {
  ...
  useEffect(() => {
    const getSiswafromdb = async () => {
      setRow(await getpakaianbyidkelas(isIdGet));
      setLoading(false);
    };
    getSiswafromdb();
  }, [reseter, isIdGet]);
      ...
      renderCell: (cellValues) => {
        return (
          <div>
            ...
            >
              <Typography fontSize={"10px"}>Bayar pakaian</Typography>
            </Button>
            <Dialog
              open={open}
              onClose={handleClose}
            ...
            >
              ...
              <DialogContent>
                <DialogContentText width={"25rem"}>
                  <b>
                    Masukkan Jumlah Pembayaran pakaian untuk informasi siswa,
                  </b>
                  <br /> Siswa <span>: </span>
                  {namatemp} <br /> kelas
                ...
                <TextField
                  ...
                  label={
                    ...
                    jumlahTerhutangPembayaran - jumlahTerbayarPembayaran
                      ? "Pembayaran pakaian   *Tidak bisa lebih dari tagihan"
                      : "Pembayaran pakaian"
                  }
                  fullWidth
            ...
            >
              ...
              <DialogContent>
                <DialogContentText width={"25rem"}>
                  <b>Edit data Pembayaran pakaian </b>
                  <br /> Siswa <span>: </span>
                  {namatemp} <br /> kelas
                  <span> : {cellValues.row.kelas}</span>
                  <br />
                ...
                <TextField
                  ...
                  id="jumlah_terbayar"
                  label="pakaian Yang sudah dibayar"
                  disabled
                  fullWidth
