...
const Databuku = () => {
  ...
  const handleBayar = async () => {
    ...
    await create_history(parseInt(jumlah), "Pembayaran buku", "-", idBayar[1]);
  ...
  const handleEdit = async () => {
    ...
    await editbuku(idedit, jumlahTerhutang);
    setReseter(reseter + 1);
    handleCloseEdit();
  };
  useEffect(() => {
  ...
  useEffect(() => {
    const getSiswafromdb = async () => {
      setRow(await getbukubyidkelas(isIdGet));
      ...
      renderCell: (cellValues) => {
        return (
          <div>
            ...
            >
              <Typography fontSize={"10px"}>Bayar buku</Typography>
            </Button>
            <Dialog
              open={open}
              onClose={handleClose}
            ...
            >
              ...
              <DialogContent>
                <DialogContentText width={"25rem"}>
                  <b>Masukkan Jumlah Pembayaran buku untuk informasi siswa,</b>
                  <br /> Siswa <span>: </span>
                  {namatemp} <br /> kelas
                ...
                <TextField
                  ...
                  label={
                    ...
                    jumlahTerhutangPembayaran - jumlahTerbayarPembayaran
                      ? "Pembayaran buku   *Tidak bisa lebih dari tagihan"
                      : "Pembayaran buku"
                  }
                  fullWidth
  ...
  return (
    <div>
      <Header title="Data buku Siswa" button_tambah={false} idkelas={isIdGet} />
      {!isIdGet && (
