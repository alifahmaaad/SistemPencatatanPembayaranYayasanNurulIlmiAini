...
const DetailEkskul = () => {
  ...
  const handleEdit = async () => {
    ...
    await editEkskul(idedit, jumlahTerhutang);
    setReseter(reseter + 1);
    handleCloseEdit();
  };
  ...
  useEffect(() => {
    const getSiswafromdb = async () => {
      setRow(await getEkskul(params.id_siswa));
      ...
      renderCell: (cellValues) => {
        return (
          <div>
            ...
            >
              <Typography fontSize={"10px"}>Bayar Ekskul</Typography>
            </Button>
            <Dialog
              open={open}
              onClose={handleClose}
            ...
            >
              ...
              <DialogContent>
                <DialogContentText width={"25rem"}>
                  <b>
                    Masukkan Jumlah Pembayaran Ekskul untuk informasi siswa,
                  </b>
                  <br /> Siswa <span>: </span>
                  ...
                  <br />
                  Ekskul Bulan <span> : </span>
                  {cellValues.row.bulan}
                  <br />
                  Jumlah Ekskul <span> : </span>Rp.
                ...
                <TextField
                  ...
                  label={
                    ...
                    jumlahTerhutangPembayaran - jumlahTerbayarPembayaran
                      ? "Pembayaran Ekskul   *Tidak bisa lebih dari tagihan"
                      : "Pembayaran Ekskul"
                  }
                  fullWidth
            ...
            >
              ...
              <DialogContent>
                <DialogContentText width={"25rem"}>
                  <b>Edit data Pembayaran Ekskul </b>
                  <br /> Siswa <span>: </span>
                  {cellValues.row.nama} <br /> kelas
                  <span> : {cellValues.row.kelas}</span>
                  <br />
                ...
                <TextField
                  ...
                  id="jumlah_terbayar"
                  label="Ekskul Yang sudah dibayar"
                  disabled
                  fullWidth
  ...
  return (
    <div>
      <Header
        title={nama.length > 0 && "Detail Ekskul \n" + nama[0].nama}
        button_tambah={true}
      />
      <div>
        <TableCustom
