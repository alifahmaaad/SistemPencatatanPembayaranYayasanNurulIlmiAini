...
import {
  editPendaftaran_ulang,
  getPendaftaran_ulangbyidkelas,
  setPendaftaran_ulangBayar,
} from "../../../Database/pendaftaranulang/dbpendaftaranulang";
import CreditCardOffIcon from "@mui/icons-material/CreditCardOff";
import PaidIcon from "@mui/icons-material/Paid";
import { create_history } from "../../../Database/database";
const Datapendaftaran_ulang = () => {
  ...
  const handleBayar = async () => {
    await setPendaftaran_ulangBayar(
      idBayar[0],
      parseInt(jumlahTerbayarPembayaran) + parseInt(jumlah)
    );
    await create_history(
      parseInt(jumlah),
      "Pembayaran pendaftaran_ulang",
      "-",
      idBayar[1]
    );
  ...
  const handleEdit = async () => {
    ...
    await editPendaftaran_ulang(idedit, jumlahTerhutang);
    setReseter(reseter + 1);
    handleCloseEdit();
  };
  useEffect(() => {
  ...
  useEffect(() => {
    const getSiswafromdb = async () => {
      setRow(await getPendaftaran_ulangbyidkelas(isIdGet));
      setLoading(false);
    };
    getSiswafromdb();
  }, [reseter, isIdGet]);
      ...
      renderCell: (cellValues) => {
        return (
          <div>
            ...
            >
              <Typography fontSize={"10px"}>Bayar pendaftaran ulang</Typography>
            </Button>
            <Dialog
              open={open}
              onClose={handleClose}
            ...
            >
              <DialogTitle color={"#53c79e"} fontWeight={"bold"}>
                Bayar pendaftaran_ulang
              </DialogTitle>
              <DialogContent>
                <DialogContentText width={"25rem"}>
                  <b>
                    Masukkan Jumlah Pembayaran pendaftaran ulang untuk informasi
                    siswa,
                  </b>
                  <br /> Siswa <span>: </span>
                  {namatemp} <br /> kelas
                  ...
                  <br />
                  Jumlah pendaftaran_ulang <span> : </span>Rp.
                ...
                <TextField
                  ...
                  label={
                    ...
                    jumlahTerhutangPembayaran - jumlahTerbayarPembayaran
                      ? "Pembayaran pendaftaran_ulang   *Tidak bisa lebih dari tagihan"
                      : "Pembayaran pendaftaran_ulang"
                  }
                  fullWidth
            ...
            >
              <DialogTitle color={"#53c79e"} fontWeight={"bold"}>
                Edit data pendaftaran_ulang
              </DialogTitle>
              <DialogContent>
                <DialogContentText width={"25rem"}>
                  <b>Edit data Pembayaran pendaftaran ulang </b>
                  <br /> Siswa <span>: </span>
                  {namatemp} <br /> kelas
                  <span> : {cellValues.row.kelas}</span>
                  <br />
                  ...
                  {cellValues.row.tingkat}
                  <br />
                  Jumlah pendaftaran ulang <span> : </span>Rp.
                ...
                <TextField
                  ...
                  id="jumlah_terbayar"
                  label="pendaftaran_ulang Yang sudah dibayar"
                  disabled
                  fullWidth
                ...
                <TextField
                  ...
                  id="jumlah_terhutang"
                  label="Jumlah Hutang pendaftaran_ulang"
                  fullWidth
  ...
  return (
    <div>
      <Header
        title="Data pendaftaran ulang Siswa"
        button_tambah={false}
        idkelas={isIdGet}
      />
      {!isIdGet && (
...
export default Datapendaftaran_ulang;
