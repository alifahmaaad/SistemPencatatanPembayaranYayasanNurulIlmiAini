      ...
      renderCell: (cellValues) => {
        return (
          <div>
            ...
            >
              <Typography fontSize={"10px"}>Detail Les UN Siswa</Typography>
            </Button>
          </div>
        );
      },
      ...
      {isIdGet && (
        <div>
          <Box paddingTop={"0.5rem"}>
            <Alert severity="info">
              Untuk Melihat Detail Pembayaran Les UN klik tombol "Detail Les UN
              Siswa"
            </Alert>
          </Box>
          <TableCustom
