      ...
      renderCell: (cellValues) => {
        return (
          <div>
            ...
            >
              <Typography fontSize={"10px"}>Detail Komite Siswa</Typography>
            </Button>
          </div>
        );
      },
      ...
      {isIdGet && (
        <div>
          <Box paddingTop={"0.5rem"}>
            <Alert severity="info">
              Untuk Melihat Detail Pembayaran Komite kilk tombol "Detail Komite
              Siswa"
            </Alert>
          </Box>
          <TableCustom
