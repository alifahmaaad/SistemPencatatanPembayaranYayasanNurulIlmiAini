      ...
      {!Loading && (
        <Box sx={{ width: "90%" }} margin="0 auto 0 auto">
          ...
          <Box display={"flex"} gap={"2rem"} flexWrap={"wrap"}>
            <Typography>
              {dataSpp.length > 0 ? (
                <Typography>Jumlah Terbayar Spp</Typography>
              ) : null}
              {dataSpp.map((option) => (
                <Box paddingLeft={"1rem"}>
            ...
            <Typography>
              {dataKomite.length > 0 ? (
                <Typography>Jumlah Terbayar Komite</Typography>
              ) : null}
            ...
            <Typography>
              {dataLes.length > 0 ? (
                <Typography>Jumlah Terbayar Les</Typography>
              ) : null}
              {dataLes.map((option) => (
                <Box paddingLeft={"1rem"}>
                  <li key={option.id} value={option.id}>
            ...
            <Typography>
              {dataLesUN.length > 0 ? (
                <Typography>Jumlah Terbayar Les UN</Typography>
              ) : null}
            ...
            <Typography>
              {dataEkskul.length > 0 ? (
                <Typography>Jumlah Terbayar Ekskul</Typography>
              ) : null}
            ...
            <Typography>
              {dataQurban.length > 0 ? (
                <Typography>Jumlah Terbayar Qurban</Typography>
              ) : null}
...
export default DetailSiswaTerbayar;
